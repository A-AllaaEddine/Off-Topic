...
const Questions = () => {
  const { selectTwoRandomPlayers, twoRandomPlayers } =
  ...
  const { playersAsk } = player1AsksPlayer2(
      ...
      {!moreQuestions ? (
        questionStart ? (
          ...
          <div className="player-question-container">
            ...
            <div className="player-question-text">
              <span>{playersAsk}</span>
              <br />
              <span>{beCarefull}</span>
              <br />
              <span>{pressNext}</span>
              <br />
            </div>
        ...
        <div className="more-questions-container">
          <div className="more-questions-text">
            <span>{ifYouHaveMoreQuestions}</span>
            <br />
            <span>{pressVote}</span>
          </div>
