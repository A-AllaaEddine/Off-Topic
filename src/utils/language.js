  ...
  switch (id) {
    case "en":
      return {
        ...
        selectRandomTopicText: "Select Random Topic",
        topics: {},
        ...
        voteForWrongImposter:
          "and make the others vote for the wrong IMPOSTER!",
        giveHint: (topicType) => {
          return {
        ...
        yourGoalIs:
          "Your goal is to find the imposter who does not know the topic",
        pressNext: "Press NEXT",
        questionTime: "Questions Time",
        everyPlayerWillAsk:
          "Every player will get to ask another player a question about the topic.",
        ...
        beCarefull:
          "Choose your question carefully, so that the imposter does not find what the topic is.",
        ifYouHaveMoreQuestions:
          "If you have more questions, it's the time to ask them.",
    ...
    case "ar":
      return {
        ...
        selectRandomTopicText: "موضوع عشوائي",
        topics: {},
        giveThePhoneToPlayer: (playerName) => {
          return {
        ...
        pressNextToCheck:
          "اضغط على التالي للتحقق مما إذا كنت داخل أو خارج الموضوع.",
        ...
        everyPlayerWillAsk:
          "يجب على كل لاعب أن يسأل لاعبًا آخر سؤالًا حول الموضوع.",
        ...
        ifYouHaveMoreQuestions:
          "إذا كان لديك المزيد من الأسئلة ، فقد حان الوقت لطرحها.",
